...
with open("C:/Users/Willi/Desktop/Food/test2.jpg", mode="rb") as test_data:
    results = predictor.detect_image('0d5ff816-e2a8-4a81-bee7-cfcbe2293962', 'Iteration10', test_data)
...
for prediction in results.predictions:
    if (prediction.probability > 0.4 ):
      if(prediction.tag_name== 'Studi'):
          img = cv2.imread('C:/Users/Willi/Desktop/Food/test2.jpg')
          y=img.shape[0]
          x=img.shape[1]
